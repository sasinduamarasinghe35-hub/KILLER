...
const sessdata = config.SESSION_ID.replace("KILLER-MD~", '');
...
console.log('KILLER-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ KILLER-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ malvin ✅*
...
*╰──────────────●●►*`;
conn.sendMessage(conn.user.id, { image: { url: config.MENU_ IMG}, caption: up })
...
//================ownerreact==============
if(senderNumber.includes("94725706007")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("94725706007")){
...
app.get("/", (req, res) => {
res.send("HEY, KILLER-MD STARTED ✅");
});
